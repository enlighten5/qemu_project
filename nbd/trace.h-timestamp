...
static inline void _nocheck__trace_nbd_receive_starttls_new_client(void)
{
    if (trace_event_get_state(TRACE_NBD_RECEIVE_STARTTLS_NEW_CLIENT)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:nbd_receive_starttls_new_client " "Setting up TLS" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      );
    }
...
static inline void _nocheck__trace_nbd_receive_simple_reply(int32_t error, const char * errname, uint64_t handle)
{
    if (trace_event_get_state(TRACE_NBD_RECEIVE_SIMPLE_REPLY)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:nbd_receive_simple_reply " "Got simple reply: { .error = %" PRId32 " (%s), handle = %" PRIu64" }" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
{
    if (trace_event_get_state(TRACE_NBD_RECEIVE_STRUCTURED_REPLY_CHUNK)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:nbd_receive_structured_reply_chunk " "Got structured reply chunk: { flags = 0x%" PRIx16 ", type = %d (%s), handle = %" PRIu64 ", length = %" PRIu32 " }" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_nbd_co_send_simple_reply(uint64_t handle, uint32_t error, const char * errname, int len)
{
    if (trace_event_get_state(TRACE_NBD_CO_SEND_SIMPLE_REPLY)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:nbd_co_send_simple_reply " "Send simple reply: handle = %" PRIu64 ", error = %" PRIu32 " (%s), len = %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
{
    if (trace_event_get_state(TRACE_NBD_CO_SEND_STRUCTURED_DONE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:nbd_co_send_structured_done " "Send structured reply done: handle = %" PRIu64 "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , handle);
    }
...
{
    if (trace_event_get_state(TRACE_NBD_CO_SEND_STRUCTURED_READ)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:nbd_co_send_structured_read " "Send structured read data reply: handle = %" PRIu64 ", offset = %" PRIu64 ", data = %p, len = %zu" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
{
    if (trace_event_get_state(TRACE_NBD_CO_SEND_STRUCTURED_READ_HOLE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:nbd_co_send_structured_read_hole " "Send structured read hole reply: handle = %" PRIu64 ", offset = %" PRIu64 ", len = %zu" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , handle, offset, size);
    }
...
{
    if (trace_event_get_state(TRACE_NBD_CO_SEND_STRUCTURED_ERROR)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:nbd_co_send_structured_error " "Send structured error reply: handle = %" PRIu64 ", error = %d (%s), msg = '%s'" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
