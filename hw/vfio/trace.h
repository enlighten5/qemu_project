...
{
    if (trace_event_get_state(TRACE_VFIO_MSIX_RELO_COST)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:vfio_msix_relo_cost " " (%s) BAR %d cost 0x%"PRIx64"" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , name, bar, cost);
    }
...
static inline void _nocheck__trace_vfio_msix_relo(const char * name, int bar, uint64_t offset)
{
    if (trace_event_get_state(TRACE_VFIO_MSIX_RELO)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:vfio_msix_relo " " (%s) BAR %d offset 0x%"PRIx64"" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , name, bar, offset);
    }
...
static inline void _nocheck__trace_vfio_spapr_group_attach(int groupfd, int tablefd)
{
    if (trace_event_get_state(TRACE_VFIO_SPAPR_GROUP_ATTACH)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:vfio_spapr_group_attach " "Attached groupfd %d to liobn fd %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , groupfd, tablefd);
    }
