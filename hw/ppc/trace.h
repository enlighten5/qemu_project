...
#define TRACE_SPAPR_IRQ_ALLOC_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_SPAPR_IRQ_ALLOC) || \
    false)

static inline void _nocheck__trace_spapr_irq_alloc(int irq)
{
    if (trace_event_get_state(TRACE_SPAPR_IRQ_ALLOC)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:spapr_irq_alloc " "irq %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , irq);
    }
...
#define TRACE_SPAPR_IRQ_ALLOC_BLOCK_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_SPAPR_IRQ_ALLOC_BLOCK) || \
    false)

static inline void _nocheck__trace_spapr_irq_alloc_block(int first, int num, bool lsi, int align)
{
    if (trace_event_get_state(TRACE_SPAPR_IRQ_ALLOC_BLOCK)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:spapr_irq_alloc_block " "first irq %d, %d irqs, lsi=%d, alignnum %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , first, num, lsi, align);
    }
...
{
    if (trace_event_get_state(TRACE_SPAPR_IRQ_FREE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:spapr_irq_free " "Source#%d, first irq %d, %d irqs" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , src, irq, num);
    }
...
{
    if (trace_event_get_state(TRACE_SPAPR_IRQ_FREE_WARN)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:spapr_irq_free_warn " "Source#%d, irq %d is already free" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , src, irq);
    }
