...
uint16_t _TRACE_VHOST_REGION_ADD_SECTION_ABUT_DSTATE;
...
TraceEvent _TRACE_VHOST_REGION_ADD_SECTION_ABUT_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "vhost_region_add_section_abut",
    .sstate = TRACE_VHOST_REGION_ADD_SECTION_ABUT_ENABLED,
    .dstate = &_TRACE_VHOST_REGION_ADD_SECTION_ABUT_DSTATE 
};
...
TraceEvent *hw_virtio_trace_events[] = {
    ...
    &_TRACE_VHOST_REGION_ADD_SECTION_ABUT_EVENT,
