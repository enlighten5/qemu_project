...
static inline void _nocheck__trace_qio_channel_websock_handshake_fail(void * ioc, const char * msg)
{
    if (trace_event_get_state(TRACE_QIO_CHANNEL_WEBSOCK_HANDSHAKE_FAIL)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:qio_channel_websock_handshake_fail " "Websock handshake fail ioc=%p err=%s" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , ioc, msg);
    }
...
static inline void _nocheck__trace_qio_channel_websock_http_greeting(void * ioc, const char * greeting)
{
    if (trace_event_get_state(TRACE_QIO_CHANNEL_WEBSOCK_HTTP_GREETING)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:qio_channel_websock_http_greeting " "Websocket HTTP request ioc=%p greeting='%s'" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , ioc, greeting);
    }
...
static inline void _nocheck__trace_qio_channel_websock_http_request(void * ioc, const char * protocols, const char * version, const char * host, const char * connection, const char * upgrade, const char * key)
{
    if (trace_event_get_state(TRACE_QIO_CHANNEL_WEBSOCK_HTTP_REQUEST)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:qio_channel_websock_http_request " "Websocket HTTP request ioc=%p protocols='%s' version='%s' host='%s' connection='%s' upgrade='%s' key='%s'" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_qio_channel_websock_header_partial_decode(void * ioc, size_t payloadlen, unsigned char fin, unsigned char opcode, unsigned char has_mask)
{
    if (trace_event_get_state(TRACE_QIO_CHANNEL_WEBSOCK_HEADER_PARTIAL_DECODE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:qio_channel_websock_header_partial_decode " "Websocket header decoded ioc=%p payload-len=%zu fin=0x%x opcode=0x%x has_mask=0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_qio_channel_websock_header_full_decode(void * ioc, size_t headerlen, size_t payloadlen, uint32_t mask)
{
    if (trace_event_get_state(TRACE_QIO_CHANNEL_WEBSOCK_HEADER_FULL_DECODE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:qio_channel_websock_header_full_decode " "Websocket header decoded ioc=%p header-len=%zu payload-len=%zu mask=0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_qio_channel_websock_payload_decode(void * ioc, uint8_t opcode, size_t payload_remain)
{
    if (trace_event_get_state(TRACE_QIO_CHANNEL_WEBSOCK_PAYLOAD_DECODE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:qio_channel_websock_payload_decode " "Websocket header decoded ioc=%p opcode=0x%x payload-remain=%zu" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_qio_channel_websock_encode(void * ioc, uint8_t opcode, size_t payloadlen, size_t headerlen)
{
    if (trace_event_get_state(TRACE_QIO_CHANNEL_WEBSOCK_ENCODE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:qio_channel_websock_encode " "Websocket encoded ioc=%p opcode=0x%x header-len=%zu payload-len=%zu" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_qio_channel_websock_close(void * ioc)
{
    if (trace_event_get_state(TRACE_QIO_CHANNEL_WEBSOCK_CLOSE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:qio_channel_websock_close " "Websocket close ioc=%p" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , ioc);
    }
