...
libs_softmmu=-lpixman-1 -lutil -lpng12 -lnettle -lgtk-3 -lgdk-3 -lpangocairo-1.0 -lpango-1.0 -latk-1.0 -lcairo-gobject -lcairo -lgdk_pixbuf-2.0 -lgio-2.0 -lgobject-2.0 -lglib-2.0 -lX11  -L$(BUILD_DIR)/dtc/libfdt -lfdt
GIT=git
...
VERSION=2.11.50
PKGVERSION=
SRC_PATH=/home/zhenxiao/qemu_switch
...
QEMU_INCLUDES=-I$(SRC_PATH)/tcg -I$(SRC_PATH)/tcg/i386 -I$(SRC_PATH)/linux-headers -I/home/zhenxiao/qemu_switch/linux-headers -I. -I$(SRC_PATH) -I$(SRC_PATH)/accel/tcg -I$(SRC_PATH)/include
AUTOCONF_HOST := 
